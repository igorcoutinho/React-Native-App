...
export const WhipAppTermsAndConditions = React.forwardRef((_, ref) => {
  ...
  return (
    <Dialog ref={DialogRef}>
      <Pdf
        source={{
          cache: true,
          uri: 'https://firebasestorage.googleapis.com/v0/b/whipapp-f3728.appspot.com/o/WhipAppTermsAndConditionsFinal.pdf?alt=media&token=2c00f40f-0027-496e-ab55-05b8365b8e24',
        }}
        scale={scale}
        style={{
          flex: 1,
